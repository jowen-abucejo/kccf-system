...
class ProgramsAndLevelSeeder extends Seeder
{
    ...
    public function run()
    {
        $program_levels = [
            ...
            ['code' => 'PGS', 'description' => 'PRE-SCHOOL'],
        ];
        ...
        $programs = [
            ['program_level_id' => 1, 'code' => 'BSIT', 'description' => 'BACHELOR OF SCIENCE IN INFORMATION TECHNOLOGY'],
            ['program_level_id' => 1, 'code' => 'BSCRIM', 'description' => 'BACHELOR OF SCIENCE IN CRIMINOLOGY'],
            ['program_level_id' => 1, 'code' => 'BSBA', 'description' => 'BACHELOR OF SCIENCE IN BUSINESS ADMINISTRATION'],
            ['program_level_id' => 1, 'code' => 'BSE', 'description' => 'BACHELOR OF SCIENCE IN SECONDARY EDUCATION MAJOR IN ENGLISH'],
            ['program_level_id' => 2, 'code' => 'SMAW', 'description' => 'SHIELDED METAL ARC WELDING'],
            ['program_level_id' => 2, 'code' => 'TVL', 'description' => 'TECHNICAL-VOCATIONAL-LIVELIHOOD'],
            ['program_level_id' => 2, 'code' => 'GAS', 'description' => 'GENERAL ACADEMIC STRAND'],
            ['program_level_id' => 3, 'code' => 'SGS', 'description' => 'JUNIOR HIGH SCHOOL'],
            ['program_level_id' => 4, 'code' => 'GS', 'description' => 'GRADE SCHOOL'],
            ['program_level_id' => 5, 'code' => 'PGS', 'description' => 'PRE-SCHOOL']
        ];
        ...
        for ($i = 0; $i < count($levels); $i++) {
            if ($i == 0) {
                ...
                $program_level = ProgramLevel::create($program_levels[1]);
            } elseif ($i == 6) {
